...
export default class Limenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>Little Pleasures</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>Desserts </Text>
            <Dash style={{marginLeft:20,marginRight:20,marginBottom:20}} dashColor='grey'/>
            <View  style={{flexDirection:'row'}}>
            <Icon name='star' style={{marginLeft:50}}/>
            <Text style={{fontSize:20,color:'black'}} >4.5</Text>
            <Text style={{marginLeft:110,marginRight:110,fontSize:20,color:'black'}}>55 mins</Text>
            <Image   source={require('./../images/rupee.png')} style={{marginTop:5}}/>
            <Text style={{fontSize:20,color:'black',marginRight:30}}>300</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>87456 ratings</Text>

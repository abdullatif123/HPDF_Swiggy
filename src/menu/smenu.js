...
export default class Smenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>Shahji by Indichow</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>North Indian </Text>
            ...
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>37896 ratings</Text>

...
export default class Fmenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>FreshMenu</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>Chinese, Continental, Italian </Text>

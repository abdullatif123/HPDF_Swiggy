...
export default class Tmenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>Theobroma</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>Fast Food </Text>
            ...
            <Text style={{marginLeft:110,marginRight:110,fontSize:20,color:'black'}}>44 mins</Text>
            <Image   source={require('./../images/rupee.png')} style={{marginTop:5}}/>
            <Text style={{fontSize:20,color:'black',marginRight:30}}>600</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>27896 ratings</Text>

...
export default class Hamenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>Handa's Restaurant</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>Indian,Chinese,Fast Food </Text>
            ...
            <Text style={{marginLeft:110,marginRight:110,fontSize:20,color:'black'}}>60 mins</Text>
            <Image   source={require('./../images/rupee.png')} style={{marginTop:5}}/>
            <Text style={{fontSize:20,color:'black',marginRight:30}}>300</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>23867 ratings</Text>

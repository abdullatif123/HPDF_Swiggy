...
export default class Emenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>East End Deli</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>Beverages,Desserts </Text>
            ...
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>25687 ratings</Text>

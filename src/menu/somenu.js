...
export default class Somenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>Soul</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>Italian,American</Text>
            ...
            <Text style={{marginLeft:110,marginRight:110,fontSize:20,color:'black'}}>68 mins</Text>
            <Image   source={require('./../images/rupee.png')} style={{marginTop:5}}/>
            <Text style={{fontSize:20,color:'black',marginRight:30}}>500</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>62534 ratings</Text>

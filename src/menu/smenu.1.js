...
export default class Nmenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            ...
            <Text style={{fontSize:20,color:'black',marginRight:30}}>150</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>18826 ratings</Text>

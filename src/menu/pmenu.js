...
export default class Pmenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>Potoba</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>Street Food,North Indian,Chinese </Text>
            <Dash style={{marginLeft:20,marginRight:20,marginBottom:20}} dashColor='grey'/>
            <View  style={{flexDirection:'row'}}>
            <Icon name='star' style={{marginLeft:50}}/>
            <Text style={{fontSize:20,color:'black'}} >4.0</Text>
            <Text style={{marginLeft:110,marginRight:110,fontSize:20,color:'black'}}>35 mins</Text>
            <Image   source={require('./../images/rupee.png')} style={{marginTop:5}}/>
            <Text style={{fontSize:20,color:'black',marginRight:30}}>500</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>34984 ratings</Text>
            ...
            <View style={{marginLeft:108,marginRight:20}}> 

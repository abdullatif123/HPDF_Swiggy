...
export default class Shmenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>Sharma Dhaba</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>North Indian,Fast Food </Text>
            ...
            <Text style={{marginLeft:110,marginRight:110,fontSize:20,color:'black'}}>61 mins</Text>
            <Image   source={require('./../images/rupee.png')} style={{marginTop:5}}/>
            <Text style={{fontSize:20,color:'black',marginRight:30}}>500</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>67425 ratings</Text>

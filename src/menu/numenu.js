...
export default class Numenu extends React.Component {
    k = () =>{
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>Nu Variety</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>North Indian,South Indian </Text>
            ...
            <Text style={{fontSize:20,color:'black',marginRight:30}}>350</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>32156 ratings</Text>

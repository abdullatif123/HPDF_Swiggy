...
export default class Mmenu extends React.Component {
 ...
 render() {
     return(
        ...
        <ScrollView>
            <Text style={{marginLeft:20,fontSize:30,color:'black'}}>Ayyappan Pure Veg</Text>
            <Text style={{marginLeft:20,fontSize:20,marginBottom:30}}>North Indian, Chinese, South Indian </Text>
            ...
            <Text style={{fontSize:20,color:'black',marginRight:30}}>400</Text>
            </View>
            <View style={{flexDirection:'row'}}>
            <Text style={{marginLeft:20,fontSize:20}}>68687 ratings</Text>
